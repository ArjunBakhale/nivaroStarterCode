...
var eventTargetShim = __webpack_require__(460);
/**
 * The signal class.
...
module.exports.HttpsAgent = __webpack_require__(8594);
module.exports.constants = __webpack_require__(6994);
...
const OriginalAgent = (__webpack_require__(3685).Agent);
const ms = __webpack_require__(1385);
const debug = (__webpack_require__(3837).debuglog)("agentkeepalive");
const { INIT_SOCKET, CURRENT_ID, CREATE_ID, SOCKET_CREATED_TIME, SOCKET_NAME, SOCKET_REQUEST_COUNT, SOCKET_REQUEST_FINISHED_COUNT } = __webpack_require__(6994);
...
const OriginalHttpsAgent = (__webpack_require__(5687).Agent);
const HttpAgent = __webpack_require__(3152);
const { INIT_SOCKET, CREATE_HTTPS_CONNECTION } = __webpack_require__(6994);
...
const usm = __webpack_require__(4286);
...
const conversions = __webpack_require__(459);
const utils = __webpack_require__(4135);
const Impl = __webpack_require__(4981);
...
exports.URL = __webpack_require__(7393)["interface"];
exports.serializeURL = __webpack_require__(4286).serializeURL;
exports.serializeURLOrigin = __webpack_require__(4286).serializeURLOrigin;
exports.basicURLParse = __webpack_require__(4286).basicURLParse;
exports.setTheUsername = __webpack_require__(4286).setTheUsername;
exports.setThePassword = __webpack_require__(4286).setThePassword;
exports.serializeHost = __webpack_require__(4286).serializeHost;
exports.serializeInteger = __webpack_require__(4286).serializeInteger;
exports.parseURL = __webpack_require__(4286).parseURL;
...
const tr46 = __webpack_require__(2697);
...
__webpack_require__.d(__webpack_exports__, {
  HP: () => (/* binding */ OpenAIStream),
  wn: () => (/* binding */ StreamingTextResponse)
});

// UNUSED EXPORTS: AIStream, AWSBedrockAnthropicStream, AWSBedrockCohereStream, AWSBedrockLlama2Stream, AWSBedrockStream, AnthropicStream, COMPLEX_HEADER, CohereStream, GoogleGenerativeAIStream, HuggingFaceStream, InkeepStream, LangChainStream, ReplicateStream, createCallbacksTransformer, createChunkDecoder, createEventStreamTransformer, createStreamDataTransformer, experimental_AssistantResponse, experimental_StreamData, experimental_StreamingReactResponse, isStreamStringEqualToType, nanoid, readableFromAsyncIterable, streamToResponse, trimStartOfStreamHelper
    ...
    constructor(){
        ...
        this.stream = new TransformStream({
            ...
            async flush (controller) {
                const warningTimeout =  false ? 0 : null;
...
async function parseComplexResponse({ reader, abortControllerRef, update, onFinish, generateId = dist_nanoid, getCurrentDate = ()=>/* @__PURE__ */ new Date() }) {
    ...
    constructor(res, options){
        ...
        if (options == null ? void 0 : options.data) {
            ...
            parseComplexResponse({
                ...
                generateId: (_a = options.generateId) != null ? _a : dist_nanoid,
                onFinish: ()=>{
...
var isFunction = __webpack_require__(8496);
...
async function* consumeBlobParts(parts, clone = false) {
    for (const part of parts){
        ...
        } else if ((0,isFunction/* isFunction */.m)(part.stream)) {
            yield* part.stream();
        } else {
...
class Blob {
    constructor(blobParts = [], options = {}){
        ...
        if (!(0,isFunction/* isFunction */.m)(blobParts[Symbol.iterator])) {
            throw new TypeError("Failed to construct 'Blob': " + "The object must have a callable @@iterator property.");
        }
        if (typeof options !== "object" && !(0,isFunction/* isFunction */.m)(options)) {
    ...
    static [(_Blob_parts = new WeakMap(), _Blob_type = new WeakMap(), _Blob_size = new WeakMap(), Symbol.hasInstance)](value) {
        return Boolean(value && typeof value === "object" && (0,isFunction/* isFunction */.m)(value.constructor) && ((0,isFunction/* isFunction */.m)(value.stream) || (0,isFunction/* isFunction */.m)(value.arrayBuffer)) && /^(Blob|File)$/.test(value[Symbol.toStringTag]));
    }
    get type() {
...
/* harmony export */ });
/* harmony import */ var _Blob_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8717);
var __classPrivateFieldSet = undefined && undefined.__classPrivateFieldSet || function(receiver, state, value, kind, f) {
    if (kind === "m") throw new TypeError("Private method is not writable");
    if (kind === "a" && !f) throw new TypeError("Private accessor was defined without a setter");
    if (typeof state === "function" ? receiver !== state || !f : !state.has(receiver)) throw new TypeError("Cannot write private member to an object whose class did not declare it");
...
class File extends _Blob_js__WEBPACK_IMPORTED_MODULE_0__/* .Blob */ .t {
    ...
    static [(_File_name = new WeakMap(), _File_lastModified = new WeakMap(), Symbol.hasInstance)](value) {
        return value instanceof _Blob_js__WEBPACK_IMPORTED_MODULE_0__/* .Blob */ .t && value[Symbol.toStringTag] === "File" && typeof value.name === "string";
    }
    get name() {
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   z: () => (/* binding */ isFile)
/* harmony export */ });
/* harmony import */ var _File_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1933);
...
// UNUSED EXPORTS: APIConnectionError, APIConnectionTimeoutError, APIError, APIUserAbortError, AuthenticationError, BadRequestError, ConflictError, InternalServerError, NotFoundError, OpenAI, OpenAIError, PermissionDeniedError, RateLimitError, UnprocessableEntityError, fileFromPath, toFile
...
class FormData_FormData {
    ...
    static [(_FormData_entries = new WeakMap(), _FormData_instances = new WeakSet(), Symbol.hasInstance)](value) {
        return Boolean(value && (0,isFunction/* isFunction */.m)(value.constructor) && value[Symbol.toStringTag] === "FormData" && (0,isFunction/* isFunction */.m)(value.append) && (0,isFunction/* isFunction */.m)(value.set) && (0,isFunction/* isFunction */.m)(value.get) && (0,isFunction/* isFunction */.m)(value.getAll) && (0,isFunction/* isFunction */.m)(value.has) && (0,isFunction/* isFunction */.m)(value.delete) && (0,isFunction/* isFunction */.m)(value.entries) && (0,isFunction/* isFunction */.m)(value.values) && (0,isFunction/* isFunction */.m)(value.keys) && (0,isFunction/* isFunction */.m)(value[Symbol.iterator]) && (0,isFunction/* isFunction */.m)(value.forEach));
    }
    ...
    *values() {
    ...
    [(_FormData_setEntry = function _FormData_setEntry({ name, rawValue, append, fileName, argsLength }) {
        ...
        name = String(name);
        let value;
        if ((0,isFile/* isFile */.z)(rawValue)) {
            value = fileName === undefined ? rawValue : new esm_File/* File */.$([
                rawValue
            ], fileName, {
                type: rawValue.type,
...
var agentkeepalive = __webpack_require__(5205);
// EXTERNAL MODULE: ./node_modules/abort-controller/dist/abort-controller.js
var abort_controller = __webpack_require__(3892);
...
const isFileLike = (value)=>Boolean(value && typeof value === "object" && util_isFunction(value.constructor) && value[Symbol.toStringTag] === "File" && util_isFunction(value.stream) && value.name != null && value.size != null && value.lastModified != null);

;// CONCATENATED MODULE: ./node_modules/form-data-encoder/lib/esm/util/isFormData.js

const isFormData = (value)=>Boolean(value && util_isFunction(value.constructor) && value[Symbol.toStringTag] === "FormData" && util_isFunction(value.append) && util_isFunction(value.getAll) && util_isFunction(value.entries) && util_isFunction(value[Symbol.iterator]));
...
// EXTERNAL MODULE: ./node_modules/web-streams-polyfill/dist/ponyfill.es2018.js
var ponyfill_es2018 = __webpack_require__(9914);
...
async function node_runtime_fileFromPath(path, ...args) {
    ...
    const { fileFromPath: _fileFromPath } = await __webpack_require__.e(/* import() */ 528).then(__webpack_require__.bind(__webpack_require__, 9528));
...
const defaultHttpAgent = new agentkeepalive({
    keepAlive: true,
    timeout: 5 * 60 * 1000
});
const defaultHttpsAgent = new agentkeepalive.HttpsAgent({
    keepAlive: true,
    timeout: 5 * 60 * 1000
});
...
const uploads_isFileLike = (value)=>value != null && typeof value === "object" && typeof value.name === "string" && typeof value.lastModified === "number" && isBlobLike(value);
/**
...
(function(Completions) {})(completions_Completions || (completions_Completions = {})); //# sourceMappingURL=completions.mjs.map
...
;// CONCATENATED MODULE: ./node_modules/openai/resources/beta/assistants/files.mjs
// File generated from our OpenAPI spec by Stainless.
...
})(files_Files || (files_Files = {})); //# sourceMappingURL=files.mjs.map

;// CONCATENATED MODULE: ./node_modules/openai/resources/beta/assistants/assistants.mjs
// File generated from our OpenAPI spec by Stainless.
...
var AbstractChatCompletionRunner_classPrivateFieldSet = undefined && undefined.__classPrivateFieldSet || function(receiver, state, value, kind, f) {
    if (kind === "m") throw new TypeError("Private method is not writable");
    if (kind === "a" && !f) throw new TypeError("Private accessor was defined without a setter");
    if (typeof state === "function" ? receiver !== state || !f : !state.has(receiver)) throw new TypeError("Cannot write private member to an object whose class did not declare it");
    return kind === "a" ? f.call(receiver, value) : f ? f.value = value : state.set(receiver, value), value;
...
class AbstractChatCompletionRunner {
    constructor(){
        ...
        _AbstractChatCompletionRunner_handleError.set(this, (error)=>{
            AbstractChatCompletionRunner_classPrivateFieldSet(this, _AbstractChatCompletionRunner_errored, true, "f");
            if (error instanceof Error && error.name === "AbortError") {
                error = new APIUserAbortError();
            }
            if (error instanceof APIUserAbortError) {
                AbstractChatCompletionRunner_classPrivateFieldSet(this, _AbstractChatCompletionRunner_aborted, true, "f");
        ...
        AbstractChatCompletionRunner_classPrivateFieldSet(this, _AbstractChatCompletionRunner_connectedPromise, new Promise((resolve, reject)=>{
            AbstractChatCompletionRunner_classPrivateFieldSet(this, _AbstractChatCompletionRunner_resolveConnectedPromise, resolve, "f");
            AbstractChatCompletionRunner_classPrivateFieldSet(this, _AbstractChatCompletionRunner_rejectConnectedPromise, reject, "f");
        }), "f");
        AbstractChatCompletionRunner_classPrivateFieldSet(this, _AbstractChatCompletionRunner_endPromise, new Promise((resolve, reject)=>{
            AbstractChatCompletionRunner_classPrivateFieldSet(this, _AbstractChatCompletionRunner_resolveEndPromise, resolve, "f");
            AbstractChatCompletionRunner_classPrivateFieldSet(this, _AbstractChatCompletionRunner_rejectEndPromise, reject, "f");
        }), "f");
        // Don't let these promises cause unhandled rejection errors.
        // we will manually cause an unhandled rejection error later
        // if the user hasn't registered any error listener or called
        // any promise-returning method.
        AbstractChatCompletionRunner_classPrivateFieldGet(this, _AbstractChatCompletionRunner_connectedPromise, "f").catch(()=>{});
        AbstractChatCompletionRunner_classPrivateFieldGet(this, _AbstractChatCompletionRunner_endPromise, "f").catch(()=>{});
    }
    _run(executor) {
        ...
        setTimeout(()=>{
            executor().then(()=>{
                this._emitFinal();
                this._emit("end");
            }, AbstractChatCompletionRunner_classPrivateFieldGet(this, _AbstractChatCompletionRunner_handleError, "f"));
        }, 0);
    }
    ...
    _connected() {
        ...
        AbstractChatCompletionRunner_classPrivateFieldGet(this, _AbstractChatCompletionRunner_resolveConnectedPromise, "f").call(this);
        this._emit("connect");
    }
    get ended() {
        return AbstractChatCompletionRunner_classPrivateFieldGet(this, _AbstractChatCompletionRunner_ended, "f");
    }
    get errored() {
        return AbstractChatCompletionRunner_classPrivateFieldGet(this, _AbstractChatCompletionRunner_errored, "f");
    }
    get aborted() {
        return AbstractChatCompletionRunner_classPrivateFieldGet(this, _AbstractChatCompletionRunner_aborted, "f");
    }
    abort() {
     ...
     */ on(event, listener) {
        const listeners = AbstractChatCompletionRunner_classPrivateFieldGet(this, _AbstractChatCompletionRunner_listeners, "f")[event] || (AbstractChatCompletionRunner_classPrivateFieldGet(this, _AbstractChatCompletionRunner_listeners, "f")[event] = []);
        listeners.push({
            listener
        });
        return this;
     ...
     * @returns this ChatCompletionStream, so that calls can be chained
     */ off(event, listener) {
        const listeners = AbstractChatCompletionRunner_classPrivateFieldGet(this, _AbstractChatCompletionRunner_listeners, "f")[event];
     ...
     */ emitted(event) {
        return new Promise((resolve, reject)=>{
            AbstractChatCompletionRunner_classPrivateFieldSet(this, _AbstractChatCompletionRunner_catchingPromiseCreated, true, "f");
    ...
    async done() {
        AbstractChatCompletionRunner_classPrivateFieldSet(this, _AbstractChatCompletionRunner_catchingPromiseCreated, true, "f");
        await AbstractChatCompletionRunner_classPrivateFieldGet(this, _AbstractChatCompletionRunner_endPromise, "f");
    }
    /**
     ...
     */ async finalChatCompletion() {
        ...
        if (!completion) throw new error_OpenAIError("stream ended without producing a ChatCompletion");
        return completion;
    }
    /**
    ...
    _emit(event, ...args) {
        ...
        const listeners = AbstractChatCompletionRunner_classPrivateFieldGet(this, _AbstractChatCompletionRunner_listeners, "f")[event];
        if (listeners) {
            AbstractChatCompletionRunner_classPrivateFieldGet(this, _AbstractChatCompletionRunner_listeners, "f")[event] = listeners.filter((l)=>!l.once);
            listeners.forEach(({ listener })=>listener(...args));
        }
        if (event === "abort") {
            const error = args[0];
            if (!AbstractChatCompletionRunner_classPrivateFieldGet(this, _AbstractChatCompletionRunner_catchingPromiseCreated, "f") && !listeners?.length) {
                Promise.reject(error);
            }
            AbstractChatCompletionRunner_classPrivateFieldGet(this, _AbstractChatCompletionRunner_rejectConnectedPromise, "f").call(this, error);
            AbstractChatCompletionRunner_classPrivateFieldGet(this, _AbstractChatCompletionRunner_rejectEndPromise, "f").call(this, error);
            this._emit("end");
            return;
        }
        if (event === "error") {
...
function finalizeChatCompletion(snapshot) {
    ...
    return {
        ...
        choices: choices.map(({ message, finish_reason, index, logprobs, ...choiceRest })=>{
            if (!finish_reason) throw new error_OpenAIError(`missing finish_reason for choice ${index}`);
            const { content = null, function_call, tool_calls, ...messageRest } = message;
            const role = message.role; // this is what we expect; in theory it could be different which would make our types a slight lie but would be fine.
            if (!role) throw new error_OpenAIError(`missing role for choice ${index}`);
            if (function_call) {
                const { arguments: args, name } = function_call;
                if (args == null) throw new error_OpenAIError(`missing function_call.arguments for choice ${index}`);
                if (!name) throw new error_OpenAIError(`missing function_call.name for choice ${index}`);
                return {
                    ...choiceRest,
                    message: {
                        content,
                ...
                return {
                    ...
                    message: {
                        ...
                        tool_calls: tool_calls.map((tool_call, i)=>{
                            ...
                            if (id == null) throw new error_OpenAIError(`missing choices[${index}].tool_calls[${i}].id\n${str(snapshot)}`);
                            if (type == null) throw new error_OpenAIError(`missing choices[${index}].tool_calls[${i}].type\n${str(snapshot)}`);
                            if (name == null) throw new error_OpenAIError(`missing choices[${index}].tool_calls[${i}].function.name\n${str(snapshot)}`);
                            if (args == null) throw new error_OpenAIError(`missing choices[${index}].tool_calls[${i}].function.arguments\n${str(snapshot)}`);
                            return {
                                ...toolRest,
                                id,
                                type,
...
})(chat_Chat || (chat_Chat = {})); //# sourceMappingURL=chat.mjs.map

;// CONCATENATED MODULE: ./node_modules/openai/resources/beta/threads/messages/files.mjs
// File generated from our OpenAPI spec by Stainless.




class messages_files_Files extends APIResource {
    /**
...
})(messages_files_Files || (messages_files_Files = {})); //# sourceMappingURL=files.mjs.map

;// CONCATENATED MODULE: ./node_modules/openai/resources/beta/threads/messages/messages.mjs
// File generated from our OpenAPI spec by Stainless.
...
class Messages extends APIResource {
    constructor(){
        super(...arguments);
        this.files = new messages_files_Files(this._client);
    }
    /**
     * Create a message.
...
(function(Messages) {
    ...
    Messages.Files = messages_files_Files;
...
/** API Client for interfacing with the OpenAI API. */ class OpenAI extends APIClient {
    /**
...
/* harmony default export */ const openai = (OpenAI); //# sourceMappingURL=index.mjs.map
